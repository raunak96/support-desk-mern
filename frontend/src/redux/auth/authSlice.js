...
export const authSlice = createSlice({
	...
	/**
	 * @desc The `extraReducers` field lets the slice handle actions defined elsewhere (for eg: NotesSlice, TicketsSlice in our case will reset when logout user is called.),
